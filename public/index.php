...
require_once('./app/api/user/signin.php');
require_once('./app/api/user/signup.php');

require_once('./app/api/projects/documentation.php');
require_once('./app/api/projects/feature.php');
require_once('./app/api/projects/groupmember.php');
require_once('./app/api/projects/presentation.php');
require_once('./app/api/projects/project.php');
require_once('./app/api/projects/proposal.php');
require_once('./app/api/projects/review.php');
require_once('./app/api/projects/srs.php');
